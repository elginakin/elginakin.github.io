...
subtitle: "Part 1: Downloading dependencies, building your environment, and running the tutorial dataset"
author: "Elgin Akin"
date: 2026-08-09
format:
  revealjs:
    ...
    progress: true
    center: false
    footer: "Pekosz Lab Nextstrain | H1N1 · H3N2 · B/Victoria Builds" 
    width: 1600
    height: 900
execute:
  echo: true
...
- This tutorial will be a bit easier if you know how to do the following in a command-line interface:
  - make a directory
  - move in/out of directories
  - check your current location
- Some knowledge of git/github is expected but not necessary. 
...
- This pipeline requires only 3 input files to run: 
  - `vaccines.fasta` - (see [tutorial: add vaccine strains from GISAID](https://github.com/Pekosz-Lab/nextstrain/tree/main#tutorial-add-vaccine-strains-from-gisaid))
  - `sequences.fasta` – sequences from the Johns Hopkins Hospital, manually concatenated runs
  - `metadata.txt` – metadata with one line per unique sample ID (excluding the segment) and associated metadata

:::{.callout-note}
For this tutorial, all three files are supplied in the [tutorial](https://github.com/Pekosz-Lab/nextstrain/tree/main/tutorial) folder
:::
...
[Back to the post](https://elginakin.github.io/posts/content/pekosz_nextstrain/)