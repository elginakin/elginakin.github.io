...
-   [Zotero](https://www.zotero.org/): free and open source
    -   My favorite add on's: 
        - [zotero action tags](https://github.com/windingwind/zotero-actions-tags)
        - [Better BibTex](https://retorque.re/zotero-better-bibtex/)
        - [ZotFile](https://zotfile.com/) [no longer compatible with Zotero 7](https://forums.zotero.org/discussion/116679/zotero-7-and-zotfile). Alternative for Z7 is [zotmoov](https://github.com/wileyyugioh/zotmoov)
        - [Zotero PDF Preview](https://github.com/windingwind/zotero-pdf-preview). [no longer compatible with Zotero 7](https://forums.zotero.org/discussion/116679/zotero-7-and-zotfile).
...
+=====================================================================================================+==================================+========================================================================================================================================+=====================================================================+===================+================================================================================================================================================================================================+
| [Obsidian](https://obsidian.md/)                                                                    | Free, open source                | Extremely Flexible superior [note backlinking](https://help.obsidian.md/Plugins/Backlinks) capabilities , `.md` (plain text) file type | Steep learning curve                                                | Yes               | [Elgin's Obsidian Lab Notebook Template](https://github.com/elginakin/obsidian_academic_lab_notebook_template/tree/main?tab=readme-ov-file#user-content-fn-2-c316ffeb53a97a8d0d6fbb949c28e25a) |
|                                                                                                     |                                  |                                                                                                                                        |                                                                     |                   |                                                                                                                                                                                                |
|                                                                                                     |                                  |                                                                                                                                        |                                                                     |                   | [ELN Blog Post](https://forum.obsidian.md/t/laboratory-notebook-integrated-task-management-system-for-bench-scientists/45338)                                                                  |
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [Benchling](https://www.benchling.com/bioresearch)                                                  | Free + Paid Plans                | Developed for Laboratory Scientists                                                                                                    | For now, all data is stored **completely** Online                   | Yes               |                                                                                                                                                                                                |
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [Microsoft Office OneNote](https://www.bioinformatics.babraham.ac.uk/training/OneNote%20manual.pdf) | Free with Microsoft Subscription | Simple UI, integrates all Office products, cloud backup, descent search.                                                               | Clunky UI. Limited to 1 template per folder. No automation options. | Yes               |                                                                                                                                                                                                |
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [AnyType](https://anytype.io/)                                                                      | Free                             | similar to Notion UX/UI and is "offline" (with included web sync service). Integrated back-linking similar to Obsidian       | Newer software, "Blackboxy" file types                              | Some              |                                                                                                                                                                                                |
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[Go to Slide Deck](https://github.com/elginakin/obsidian_academic_lab_notebook_template/blob/main/_%20%F0%9F%8E%89%20Welcome%20(Start%20Here)/Slide%20Deck%20-%20PhD_Student_Data_Management.pdf)


## 🖥️ Scripting and Reproducibility

-   [VS Code](https://code.visualstudio.com/): A lightweight and accessible text editor.
-   [Rstudio IDE](https://posit.co/download/rstudio-desktop/)
-   [Positron IDE](https://positron.posit.co/): For Joint R + Python development. Based on VS Code.
...
-   [Github Co Pilot](https://github.com/features/copilot): Nice AI assistant and can be integrated in VS Code. Free Education license available.
...
## SNP calling from multi-FASTA 

This is a somewhat niche use case for bacterial and small viral genomes but I have found myself needing to call SNPs from multi-FASTA files of consensus sequences. Ironically, I experienced a bit of a learning curve when calling SNPs from consensus contigs/cds sequences as opposed to FASTQ.  

- [snp-sites](https://github.com/sanger-pathogens/snp-sites)
  - Ingests a sequence alignment and reference genbank for variant calling. Outputs a VCF file or pseudo-aligned SNPs.
- [snippy](https://github.com/tseemann/snippy/tree/master): Snippy can in fact ingest a multi-FASTA file using the `--contigs` flag. 
  > "allows you to call SNPs from contigs rather than reads. It shreds the contigs into synthetic reads, as to put the calls on even footing with other read samples in a multi-sample analysis."


## 🧬 Sequence Motif and Similarity Searches

-   [dbPTM](https://awi.cuhk.edu.cn/dbPTM/): Integrtated resource for post transnational modifications. Can enter by keywords or by [`.fasta` sequence](https://awi.cuhk.edu.cn/dbPTM/search.php)
-   [EMBL-EBI](https://www.ebi.ac.uk/services/data-resources-and-tools) has an incredible wealth of freely available tools for molecular data analysis. Some I use often include:
...
-   [Molecular Nodes](https://bradyajohnston.github.io/MolecularNodes/): This is my personal module for visualizing crystal structures (although it is so much more than that)
...
-   [enhancedvolcano](https://bioconductor.org/packages/release/bioc/html/EnhancedVolcano.html): a tidy volcano plot package so that you do not have to make yours from scratch :)
...
-   [treesort](https://github.com/flu-crew/TreeSort): Package for inferring reassortment rates between 2 phylogenetic trees.
...
-   [MAFFT](https://mafft.cbrc.jp/alignment/server/index.html): Align big datasets for free in 'the cloud'! MAFFT is widely used for aligning DNA, RNA, and protein sequences, and it offers several algorithms optimized for different types of sequences and alignment tasks. MAFFT can handle large datasets efficiently and is available both as a standalone program and through a web server interface.

# 💻 Computer Resources for statistical interrogation and visualization

For statistics and visualization, I am more biased to solutions in R due to its simplicity and ease of reproducibility between users and machines. To me, this is expecially important when publishing scripts during the manuscript publication process. 

### Resources for approaching data visualization heuristics
...
-   Yan Holtz's [data2viz](https://www.data-to-viz.com/) guidelines for appropriate visualization of data. An excellent resource which explains the pros and caveats for numeric, categoric, Num+Cat, mapped, network and time series data.
...
It is especially critical to consider color when generating figures for your audience. Here are a few tools I have referenced which can assess common and custom pallets across major color populations including Deuteranomaly, Protanomaly, Protanopia, and Deuteranopia:
...
The following are some of my favorites visualization libraries in R and Python. This list is not even close to exhaustive but these cover my basics.

-   For simple and elegant scientific plots, I have started using [tidyplots](https://tidyplots.org/). Built around [ggplot2](https://ggplot2.tidyverse.org/index.html), tidyplots offers simplified syntax for publication-ready plots. It has saved me so much time in the figure-making process. 
    - Read the [publication](https://onlinelibrary.wiley.com/doi/10.1002/imt2.70018)
...
-   [ggmsa](https://github.com/YuLab-SMU/ggmsa): MSA viewer appropriate for visualization of short aa or nt alignments. Preloaded with different tracks showing consensus, stacked composition, motif highlighting, etc.
...
High-level Languages which mesh incredibly well with sequencing-based bioinformatics - [RUST](https://www.rust-lang.org/): 🫠 - [Go](https://go.dev/) 🏃🏻‍♂️💨 - C++: Of course.
