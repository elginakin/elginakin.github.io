...
-   [Zotero](https://www.zotero.org/): free and open source
    -   My favorite add on's: [zotero action tags](https://github.com/windingwind/zotero-actions-tags), [Better BibTex](https://retorque.re/zotero-better-bibtex/), [ZotFile](https://zotfile.com/), [Zotero PDF Preview](https://github.com/windingwind/zotero-pdf-preview)
...
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [AnyType](https://anytype.io/)                                                                      | Free                             | Encypted, similar to Notion UX/UI and is "offline" (with included web sync service). Integrated back-linking similar to Obsidian       | Newer software, "Blackboxy" file types                              | Some              |                                                                                                                                                                                                |
+-----------------------------------------------------------------------------------------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
