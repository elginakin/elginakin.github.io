...
- [Rstudio IDE](https://posit.co/download/rstudio-desktop/) - Of course
- [Quarto](https://quarto.org/): also developed by posit. Similar to Rmarkdown but supports multiple languages. Extremely powerful. 
- [Jupyter](https://jupyter.org/) notebooks. Essential for python users. 
...
- [Warp](https://www.warp.dev/) (MacOS Only as of Feb 2024): A fancy shansy command line utility terminal with integrated features such as autocomplete, pipelines, its own AI. 
...
## ☁️ Online and cloud-based computational resources 
...
For statistics and visualization, I am more biased to solutions in R. The following are some of my favorites visualization libraries in R and Python. This list is not exhaustive and there is so much out there but these cover my basics. 
